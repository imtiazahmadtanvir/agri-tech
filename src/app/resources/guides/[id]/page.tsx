    ...
    <main className="min-h-screen bg-gray-50 pb-16">
      ...
      <div className="mx-auto max-w-4xl px-4">
        ...
        <div className="mt-8 rounded-lg bg-white p-6 shadow-md">
          <h3 className="mb-4 text-xl font-bold text-gray-800">About the Author</h3>
          <div className="flex items-start">
            ...
            <div>
              <h4 className="text-lg font-semibold text-gray-800">{guide.author}</h4>
        ...
        {/* Related Guides */}
        <div className="mt-12">
          <h2 className="mb-6 text-2xl font-bold text-gray-800">Related Guides</h2>
...
const guides = [
  {
    ...
    introduction: "Water is one of the most precious resources in agriculture. This guide explores modern irrigation techniques that can help farmers conserve water while ensuring optimal crop growth and yield.",
    image: "https://i.ibb.co.com/XrX5KD7f/Understanding-Agricultural-Futures-Markets.jpg",
    category: "Water Management",
    date: "May 20, 2023",
    readTime: 12,
    author: "Dr. Sarah Johnson",
    authorBio: "Agricultural scientist with 15 years of experience in water conservation and irrigation systems. Dr. Johnson has worked with farmers across three continents to implement sustainable water management practices.",
    sections: [
      {
        title: "Understanding Water Efficiency in Agriculture",
        content: "Water efficiency in agriculture refers to the ratio of crop yield to the amount of water used. With climate change affecting rainfall patterns and water availability, it's becoming increasingly important for farmers to adopt efficient irrigation methods that minimize water waste while maximizing crop productivity.",
      ...
      },
      {
        ...
        content: "Smart irrigation technology combines traditional irrigation methods with sensors, weather data, and automation to optimize water usage. These systems can monitor soil moisture levels, weather conditions, and plant water needs to deliver precisely the right amount of water at the right time."
      }
    ],
    proTip: "When installing drip irrigation, place the emitters at the root zone of plants rather than at the stem to encourage deeper root growth and better water absorption.",
    steps: [
      {
        title: "Assess Your Water Resources",
        description: "Before implementing any irrigation system, conduct a thorough assessment of your available water resources, including quantity, quality, and reliability."
      },
      {
        title: "Choose the Right System for Your Crops",
        description: "Different crops have different water requirements. Research and select an irrigation system that best suits your specific crops and growing conditions."
      },
      {
        title: "Install Soil Moisture Sensors",
        description: "Place soil moisture sensors at various depths and locations in your field to monitor water penetration and soil moisture levels accurately."
      },
      {
        title: "Set Up Weather Monitoring",
        description: "Install a weather station or connect to local weather services to integrate real-time weather data into your irrigation scheduling."
      },
      {
        title: "Implement Automation",
        description: "Use controllers and automation software to schedule irrigation based on sensor data, weather forecasts, and crop water needs."
      }
    ],
    conclusion: "Adopting modern irrigation techniques is not just about conserving water; it's about improving crop quality, reducing costs, and ensuring the sustainability of your farming operation. By investing in efficient irrigation systems and smart technology, farmers can achieve better results with less water, contributing to both their bottom line and environmental conservation."
  },
...
const relatedGuides = [
  ...
  },
  {
    ...
    image: "https://i.ibb.co.com/wryw8jT4/Seasonal-Crop-Calendar-for-Northern-India.jpg",
    category: "Soil Management"
  },
  {
    id: 4,
    title: "Crop Rotation Strategies",
    image: "https://i.ibb.co.com/sd53Mxs2/Success-Story-Transitioning-to-Sustainable-Rice-Farming.jpg",
